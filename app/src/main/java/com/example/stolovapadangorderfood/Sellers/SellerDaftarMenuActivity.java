...
public class SellerDaftarMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_daftar_menu);
        ...
        recyclerView = findViewById(R.id.recycler_daftarmenu_seller);
                    ...
                    protected void onBindViewHolder(@NonNull SelleritemViewHolder holder, int position, @NonNull final Products model)
                    {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view)
                            {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(SellerDaftarMenuActivity.this);
    ...
    private void deleteProduct(String productID)
    {
        unverifiedProductsRef.child(productID)
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    {
                        Toast.makeText(SellerDaftarMenuActivity.this, "Item Berhasil Dihapus.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
